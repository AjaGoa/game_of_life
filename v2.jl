...
fig = Figure(size = (GRID_PIXELS + 200, GRID_PIXELS + 400))  #space for controls
...
ax = Axis(gl[1, 1], 
    ...
    backgroundcolor = :white)  # Grid lines at 0, 0 a pak posunute, didnt find way how to shift them in axis by half
...
generation_label = Label(fig[1, 2], lift(x -> "Generation: $x", current_gen),
