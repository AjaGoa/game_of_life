...
mutable struct Board
    board::AbstractMatrix{Bool} # lepsi jenom Matrix nez AbstractMatrix - obecnejsi - jenom Matrix nefunguje - nepredava si spravne indexovani - moc hodnot
    new_board::AbstractMatrix{Bool}# radsi udelat similar boardu 
end

# ruzne druhy konstruktoru
...
#Base.size(b::Board) = size(b.board) # potrebuju definovat a rozsirit metodu ?
